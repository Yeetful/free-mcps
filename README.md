...
`ETH_RPC_URL` (lido; optional — overrides the default public mainnet RPC) plus
`LIDO_ETH_API_URL` / `LIDO_REWARD_API_URL` / `LIDO_WQ_API_URL` (lido; default
to Lido's public APIs),
